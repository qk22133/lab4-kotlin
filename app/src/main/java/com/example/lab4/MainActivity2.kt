...
class MainActivity2 : AppCompatActivity() {
    private var send_btn: Button = findViewById(R.id.btn_send)
    private var set_drink: EditText = findViewById(R.id.ed_drink)
    private var rg1: RadioGroup = findViewById(R.id.radioGroup)
    private var rg2: RadioGroup = findViewById(R.id.radioGroup)
